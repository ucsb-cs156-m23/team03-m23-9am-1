...
describe("UCSBOrganizationIndexPage tests", () => {
    ...
    test("renders three organizations correctly for regular user", async () => {
        ...
        const orgCode = screen.getByText("WICS");
        expect(orgCode).toBeInTheDocument();

        const shortOrgTranslation = screen.getByText("Women in CS");
        expect(shortOrgTranslation).toBeInTheDocument();

        const orgTranslation = screen.getByText("Women in Computer Science at UCSB");
